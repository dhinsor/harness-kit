...
4. Save it where the repo already keeps such notes, matching the existing convention. If there is none, default to `docs/research-<topic>.md` (create `docs/` if needed) and say where it was saved.
